...
示例代码：单进程读写管道（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\01_pipe_basic_parent_child.c）
...
### 任务二：管道读写行为规律分析
#### 2.1 读写端都存在，只读不写
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\02_pipe_read_only_block.c）
#### （1）实验目的
...
#### 2.2 读写端都存在，只写不读
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\03_pipe_write_only_block.c）
#### （1）实验目的
...
#### 2.3 只有读端，没有写端
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\04_pipe_eof_read.c）
#### （1）实验目的
...
---
#### 2.4 只有写端，没有读端
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\05_pipe_sigpipe.c）
#### （1）实验目的
...
### 任务三：双向通信的无名管道协作模型
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\06_pipe_bidirectional.c）
#### （1）实验目的
...
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\07_pipe_nonblock.c）
#### （1）实验目的
...
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\08_fd_open_limit.c）
```c
#include <stdio.h>
#include <sys/types.h>
#include <sys/stat.h>
...
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\09_dup_basic.c）
#### （1）实验目的
...
#### 4.1.2 实现输出重定向的功能
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\010_dup_redirect.c）
#### （1）实验目的
...
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\011_dup_restore_stdout.c）
#### （1）实验目的
...
- 返回值：
  ...
  - 失败：返回‐1，错误代码存于errno中
#### 4.2.1 实现输出重定向
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\012_dup2_redirect_restore.c）
#### （1）实验目的
...
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\013_dup2_redirect_stdout.c）
#### （1）实验目的
