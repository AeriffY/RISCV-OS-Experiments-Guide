...
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\11_mkfifo_create.c）
...
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\12_fifo_single_rw.c）
#### （1）实验目的
...
（源码请见ORISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\13_fifo_send.c）
...
（源码请见OS\RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\14_fifo_recv.c）
...
#### 4.1 读写端都存在，只读不写
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\15_fifo_block_read_only.c）
...
#### 4.2 读写端都存在，只写不读
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\16_fifo_block_write_only.c）
...
#### 4.3 在一个进程中只有读端，没有写端
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\17_fifo_only_read.c）
...
#### 4.4 在一个进程中只有写端，没有读端
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\18_fifo_only_write.c）
...
### 任务五：有名管道的读写规律（非阻塞）
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\19_fifo_nonblock_read.c；RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\110_fifo_nonblock_write.c）
...
### 任务六：父子进程通过 FIFO 通信
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\111_fifo_fork_comm.c）
...
（源码请见RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\112_fifo_reader.c；RISCV-OS-Experiments-Guide\实验四：进程间通信与管道实验\src\113_fifo_writer_pid.c）
